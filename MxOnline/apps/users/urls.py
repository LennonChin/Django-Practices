...
from .views import UserInfoView, UploadImageView, UpdatePasswordView, SendEmailCodeView, UpdateEmailView, MyCourseView, MyFavoriteOrgView, MyFavoriteTeacherView, MyFavoriteCourseView
